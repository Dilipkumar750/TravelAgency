    ...
    <>
     ...
     { /* Image Section */}
        <div className="flex flex-col md:flex-row items-center">
          <img src={TOP} alt="Flight" className="w-full md:w-1/2"/>
          
          <div className="bg-white rounded-2xl shadow-2xl p-7 w-full max-w-md mx-auto md:ml-5 mt-8 md:mt-0">
          <div className="mb-6">
        ...
        {/* Contact Info Cards */}
        <div className=" grid grid-cols-1 md:grid-cols-3 gap-10 p-12 transform transition-all duration-500 ease-[cubic-bezier(0.15,0.83,0.66,1)] cursor-pointer ">
