...
function App() {
  ...
  return (
    <BrowserRouter>
      ...
      <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-1/2 bg-black/70 text-center py-2 shadow-lg rounded-lg flex items-center justify-between gap-2 z-50 p-10">
      ...
      {isModalOpen && (
      <div
      className="fixed inset-0 bg-black/70 flex justify-center items-center z-50 p-20"
    >
      <div
        className="relative bg-gradient-to-r from-blue-200 to-blue-400 rounded-xl shadow-2xl p-8 w-full max-w-md transform transition-transform scale-100"
      >
        {/* Close Icon */}
        <button
        ...
        <div className="mb-4">
          ...
          <div className="flex gap-4">
            <input
              id="startDate"
              type="date"
              className="w-1/2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 px-4 py-2"
            />
            <input
              id="endDate"
              type="date"
